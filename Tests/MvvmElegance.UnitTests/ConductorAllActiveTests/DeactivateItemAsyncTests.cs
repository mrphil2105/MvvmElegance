...
public class DeactivateItemAsyncTests
{
    [Theory]
    [AutoData]
    public async Task DeactivateItemAsync_DeactivatesScreen(Conductor<Screen>.Collection.AllActive conductor,
        Screen screen)
    {
    ...
    [Theory]
    [AutoData]
    public async Task DeactivateItemAsync_DoesNotSetScreenParent(Conductor<Screen>.Collection.AllActive conductor,
        Screen screen)
    {
        await conductor.DeactivateItemAsync(screen);
